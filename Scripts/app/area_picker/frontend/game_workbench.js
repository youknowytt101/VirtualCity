(function() {
  ...
  function createCharacter() {
    ...
    var toon = createToonGrayMaterial();
    var BodyGeometry = THREE.CapsuleGeometry || THREE.CylinderGeometry;
    var bodyGeometry = THREE.CapsuleGeometry
      ? new BodyGeometry(0.28, 0.85, 6, 14)
      : new BodyGeometry(0.28, 0.28, 1.15, 14);
    var headGeometry = new THREE.SphereGeometry(0.26, 24, 16);
    var footGeometry = new THREE.BoxGeometry(0.24, 0.42, 0.12);
    var body = new THREE.Mesh(bodyGeometry, toon);
    var head = new THREE.Mesh(headGeometry, toon);
    var leftFoot = new THREE.Mesh(footGeometry, toon);
    var rightFoot = new THREE.Mesh(footGeometry, toon);
