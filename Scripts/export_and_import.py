...
EXPORTS = [
    ...
    ('roads',     [f'{_OBJ}/road_surface_color', f'{_OBJ}/road_capsule_surface_preview', f'{_OBJ}/road_color', f'{_OBJ}/road_profile_apply', f'{_OBJ}/road_clipped', f'{_OBJ}/road_junction_curve_smooth', f'{_OBJ}/road_vertex_cleanup', f'{_OBJ}/road_turn_curve_smooth', f'{_OBJ}/road_centerline_resample', f'{_OBJ}/road_api_shared_topology', f'{_OBJ}/road_api_raw_lines'], 'roads_v001.fbx'),
