...
# shared/vc_paths.py lives under Scripts/shared/.  The project root is two
# levels above Scripts, not the Scripts directory itself.
ROOT = Path(__file__).resolve().parents[2]
SCRIPTS = ROOT / "Scripts"
CONFIG = ROOT / "Config"
DATA_ROOT = ROOT / "RawData"
DOWNLOADS = DATA_ROOT / "_downloads"
CLEANED = DATA_ROOT / "_cleaned"
HOUDINI_READY = DATA_ROOT / "_houdini_ready"
HOUDINI = ROOT / "Houdini"
HIP = HOUDINI / "Hip" / "VC_master_citygen_v001.hip"
