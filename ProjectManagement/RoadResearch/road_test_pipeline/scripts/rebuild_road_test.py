...
def main() -> int:
    ...
    steps.extend([
        ...
        ("Generating semantic evidence summary", [python_cmd(), str(root / "scripts" / "generate_semantic_evidence_summary.py"), "--area-id", args.area_id]),
    ...
    summary = {
        ...
        "outputs": {
            ...
            "semantic_evidence_summary": str(root / "reports" / f"{args.area_id}_semantic_evidence_summary.json"),
